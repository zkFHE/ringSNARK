...
class r1cs_constraint {
 public:
  ...
  friend std::istream &operator>>
      <RingT>(std::istream &in, r1cs_constraint<RingT> &c);
};
...
class r1cs_constraint_system {
 public:
  ...
  friend std::ostream &operator<< <RingT>(
      std::ostream &out, const r1cs_constraint_system<RingT> &cs);

  friend std::istream &operator>>
      <RingT>(std::istream &in, r1cs_constraint_system<RingT> &cs);
